...
public class ExceptionCatch {
    ...
    public ResponseResult customException(CustomException customException) {
        ...
        // 记录日志
        LOGGER.error("catch com.abigtomato.shop.common.exception:{}", customException.getMessage());
    ...
    public ResponseResult exception(Exception exception){
        ...
        // 记录日志
        LOGGER.error("catch com.abigtomato.shop.common.exception: {}", exception.getMessage());
        if (EXCEPTIONS == null) {
